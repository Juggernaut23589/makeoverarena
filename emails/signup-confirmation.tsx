      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={heroSection}>
            ...
            <Text style={heroText}>
              Hi {studentName}, you&apos;ve successfully signed up and your
              dashboard has been created. An admin will reach out to you
              shortly to guide you through your application.
            </Text>
            <Text style={heroText}>
              To keep things moving, head to your dashboard and book your
              free 15-minute consultation — that&apos;s the next step in your
              application process.
            </Text>
          </Section>
